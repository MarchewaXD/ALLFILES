...
if (isset($_POST['oplac'])) {
    $id = $_POST['id_faktury'];
    mysqli_query($conn, "UPDATE sprzedazowe SET oplacona = 1 WHERE id = $id");
}
 
$nieoplacone = mysqli_query($conn, "SELECT id, numer_faktury FROM sprzedazowe WHERE oplacona = 0");
?>
